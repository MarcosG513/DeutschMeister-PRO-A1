...
const chapters = [{
  ...
  words: [{
    ...
    pron: "shtáts-án-gue-jó-rij-kait",
    es: "nacionalidad",
    type: "Sustantivo (Fem)",
    category: "Dokumente",
