  ...
  return (
    <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 shadow-sm max-w-xl mx-auto my-6 text-left">
      ...
      <div className="relative min-h-[140px] bg-white border border-slate-100 rounded-xl p-4 flex flex-col justify-between mb-6 overflow-hidden">
        <div className="hidden sm:flex flex-row justify-between text-center text-[10px] font-bold text-slate-400 uppercase w-full">
        ...
        <div className="flex flex-wrap justify-center gap-2 items-center my-4 relative w-full">
          {/* Sujeto */}
          <div className="w-full sm:w-1/4 lg:w-[180px] min-w-[120px] bg-blue-50 border-2 border-blue-200 text-blue-900 rounded-xl p-2 sm:px-4 sm:py-2 text-center font-bold text-xs sm:text-sm md:text-base leading-tight transition-all break-words whitespace-normal overflow-hidden">
            {present.subject}
            <span className="block text-[9px] font-normal text-blue-600/80 mt-0.5">Sujeto</span>
          </div>

          {/* Verbo Principal / Auxiliar */}
          <div className="w-full sm:w-1/4 lg:w-[180px] min-w-[120px] relative h-[64px] flex items-center justify-center">
            {/* Verbo en Presente */}
            <div 
              className="absolute inset-0 bg-indigo-50 border-2 border-indigo-200 text-indigo-900 rounded-xl p-2 sm:px-4 sm:py-2 text-center font-bold text-xs sm:text-sm md:text-base leading-tight transition-all flex flex-col justify-center items-center max-w-full break-words whitespace-normal overflow-hidden"
              style={{
                opacity: 1 - t,
            ...
            {/* Auxiliar en Pasado */}
            <div 
              className="absolute inset-0 bg-emerald-600 border-2 border-emerald-600 text-white rounded-xl p-2 sm:px-4 sm:py-2 text-center font-bold text-xs sm:text-sm md:text-base leading-tight transition-all flex flex-col justify-center items-center shadow-sm max-w-full break-words whitespace-normal overflow-hidden"
              style={{
                opacity: t,
          ...
          {/* Complemento */}
          <div className="w-full sm:w-auto max-w-[95%] sm:max-w-[250px] lg:max-w-xs bg-slate-50 border-2 border-slate-200 text-slate-800 rounded-xl p-2 sm:px-4 sm:py-2 text-center font-bold text-xs sm:text-sm md:text-base leading-tight transition-all break-words whitespace-normal overflow-hidden">
            {present.complement}
          ...
          <div className="w-full sm:w-1/4 lg:w-[180px] min-w-[120px] relative h-[64px] flex items-center justify-center">
            <div 
              className="absolute inset-0 bg-emerald-50 border-2 border-emerald-200 text-emerald-950 rounded-xl p-2 sm:px-4 sm:py-2 text-center font-bold text-xs sm:text-sm md:text-base leading-tight transition-all flex flex-col justify-center items-center max-w-full break-words whitespace-normal overflow-hidden"
              style={{
                opacity: t,
