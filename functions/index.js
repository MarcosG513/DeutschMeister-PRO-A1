...
export const generateStory = onRequest({
  ...
  try {
    ...
    const promptSistema = "Eres un creador de cuentos infantiles y profesor de alemán nivel A1. Tu objetivo es escribir historias coherentes, inmersivas y gramaticalmente perfectas integrando vocabulario específico. REGLA DE CASOS GRAMATICALES (CRÍTICO): Está estrictamente prohibido colocar artículos nominativos ('der/die/das') en posiciones de acusativo o dativo. Debes declinar correctamente los artículos según la sintaxis de la oración. Por ejemplo, verbos como 'sehen', 'haben', 'kaufen', 'essen' exigen acusativo (escribe 'Er sieht den Schnee' en vez de 'Er sieht der Schnee'; 'den Apfel' en vez de 'der Apfel'; 'den Hund' en vez de 'der Hund'). Preposiciones de movimiento como 'in' o 'zu' exigen el caso correcto (escribe 'in den Park' o 'in den Bahnhof' en vez de 'in der Park'). No cometas errores de casos bajo ninguna circunstancia.";
