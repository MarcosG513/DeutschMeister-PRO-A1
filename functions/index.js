...
- Frase 2: Analogía lúdica del mundo real. Explica el mecanismo del juego en abstracto. Está COMPLETAMENTE PROHIBIDO emparejar palabras alemanas con su significado (ej. no digas 'du es para amigos'), ni dar ejemplos reales declinados, conjugados o estructurados en alemán (ej. no muestres 'den', 'meine', 'Häuser' ni 'Ich lerne'). Si explicas reglas de cambio (acusativo, posesivos, plurales), hazlo como cambios de uniforme abstractos (ej. 'añade una colita -e' o 'cambia su final por -n') sin revelar la palabra cambiada.
